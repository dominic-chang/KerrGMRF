...
inimg = Comrade.regrid(Comrade.load_fits("/n/home06/dochang/KerrGMRF/src/phibi_2017_phase_wrapped_no_n1_variability/3598_blur_avg.fits", IntensityMap), imagepixels(fovx, fovy, 3npixx, 3npixy; executor = ThreadsEx()))
mimg = mean(imgs)
